...
LINKER_FLAGS=-X github.com/johnrlowry/copilot-cli/internal/pkg/version.Version=${VERSION}\
-X github.com/johnrlowry/copilot-cli/internal/pkg/cli.binaryS3BucketPath=${BINARY_S3_BUCKET_PATH}
